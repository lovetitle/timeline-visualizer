  ...
  updates: {
    zh: {
      ...
      items: [
        ...
        '大檔降採樣、圖磚／編碼失敗重試、ETA、預覽倍速、交通節奏',
        '深色模式、設定匯入匯出、快捷鍵、PWA 更新提示、繁中／英／日／韓',
        '隱私報告頁、版本紅點、本機效能統計（v1.2.0）',
    ...
    en: {
      ...
      items: [
        ...
        'Downsampling, tile/encode retries, ETA, preview speed, transport pacing',
        'Dark mode, settings import/export, shortcuts, PWA update prompt, zh/en/ja/ko',
        'Privacy report, version badge, local perf stats (v1.2.0)',
