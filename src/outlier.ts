...
const MAX_PLAUSIBLE_SPEED_KMH = 1300;
...
function isSuspiciousExcursion(
  before: GeoPoint,
  points: GeoPoint[],
  start: number,
  end: number,
...
function suspiciousRunEnd(points: GeoPoint[], before: GeoPoint, start: number): number | null {
...
export function filterLocationOutliers(
  points: GeoPoint[],
